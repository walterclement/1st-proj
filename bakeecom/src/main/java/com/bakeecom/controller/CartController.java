...
public class CartController {
	...
	public String add(@PathVariable("pid") int id) {
		Cart cart = new Cart();
		Product pm = dataService.getRowById(id);
	...
	public String delteallcart()
	{
		...
		{
			int getprdit=decart.get(i).getProduct().getPid();
			int delquan=decart.get(i).getQuantity();
			prdcntrl.addproductstock(getprdit,delquan);	
		}
